...
{-# LINE 115 "MainData.hs"#-}

data GSymbol = HappyEOF | HappyTok {-!Int-} (Char) | G_E 
...
type UserDefTok = Char
instance TreeDecode (Char) where
  decode_b f (Branch (SemTok t) []) = [happy_return t]
instance LabelDecode (Char) where
  unpack (SemTok t) = t


action 0 ( HappyTok ('a') ) = Shift 2 []
action 0 ( HappyTok ('b') ) = Shift 4 []
action 0 ( HappyEOF ) = Reduce [red_3]
action 1 ( HappyTok ('a') ) = Shift 2 []
action 2 ( HappyTok ('a') ) = Shift 2 [red_3]
action 2 ( HappyTok ('b') ) = Shift 4 []
action 3 ( HappyEOF ) = Accept
action 4 ( HappyTok ('a') ) = Shift 2 []
action 4 ( HappyTok ('b') ) = Shift 4 [red_3]
action 5 ( HappyTok ('b') ) = Shift 8 []
action 6 ( HappyTok ('a') ) = Shift 7 []
action 7 ( HappyTok ('a') ) = Reduce [red_1]
action 7 ( HappyTok ('b') ) = Reduce [red_1]
action 7 ( HappyEOF ) = Reduce [red_1]
action 8 ( HappyTok ('a') ) = Reduce [red_2]
action 8 ( HappyTok ('b') ) = Reduce [red_2]
action 8 ( HappyEOF ) = Reduce [red_2]
action _ _ = Error
red_1 = (G_E,3 :: Int,semfn_0_0)
red_2 = (G_E,3 :: Int,semfn_0_0)
red_3 = (G_E,0 :: Int,semfn_0_0)
goto 0 G_E = 3
